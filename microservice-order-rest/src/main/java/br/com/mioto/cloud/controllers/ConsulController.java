...
public class ConsulController {
    ...
    @Value("${spring.application.name:order-rest}")
    ...
    private String getDependencyJson(){
        ...
        dependency.setName("microservice-mail-relay-rest");
        dependencyList.add(dependency);

        dependency = new Microservice();
        dependency.setVersion("1.0");
        dependency.setName("microservice-billing-rest");
        dependencyList.add(dependency);

        dependency = new Microservice();
        dependency.setVersion("1.0");
        dependency.setName("microservice-delivery-rest");
        dependencyList.add(dependency);
        ...
        dependency = new Microservice();
        dependency.setVersion("1.0");
        dependency.setName("microservice-access-manager-rest");
        dependencyList.add(dependency);

        dependency = new Microservice();
        dependency.setVersion("1.0");
        dependency.setName("microservice-user-manager-rest");
        dependencyList.add(dependency);
