...
public class ConsulController {
    ...
    @Value("${spring.application.name:basket-rest}")
    ...
    private String getDependencyJson(){
        ...
        dependency = new Microservice();
        dependency.setVersion("1.0");
        dependency.setName("microservice-inventory-rest");
        dependencyList.add(dependency);

        dependency = new Microservice();
        dependency.setVersion("1.0");
        dependency.setName("microservice-fare-rest");
        dependencyList.add(dependency);
        ...
        dependency = new Microservice();
        dependency.setVersion("1.0");
        dependency.setName("microservice-order-rest");
        dependencyList.add(dependency);
